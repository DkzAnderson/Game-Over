...
export const Register = () => {
  ...
  const styles = {
    ...
    form: {
      ...
      button: "bg-rd hover:bg-th active:bg-th text-nd h-12 w-full py-2 text-lg font-bold rounded-lg mt-4",
    },
    ...
    <section className={styles.main}>
      ...
      <div className={styles.content}>
        <Form className={styles.form.main}>
          <h2 className={styles.form.title}>Registro de Usuarios</h2>
